...
if( empty($get_field_1) || empty($get_field_2)  || empty($get_field_4) || 
	empty($get_field_5) || empty($get_field_6)  || empty($get_field_7)   )
{
	$response["success"] = 2;
...
{
	$result = mysql_query("INSERT INTO appoinment( email, field_1, field_2, field_3, field_4,
							field_5, field_6,field_7, field_8, created_date	)
					VALUES(	'$get_email','$get_field_1', '$get_field_2', '$get_field_3', 
							'$get_field_4', '$get_field_5', '$get_field_6','$get_field_7','$get_field_8',
							'$get_created_date')");
